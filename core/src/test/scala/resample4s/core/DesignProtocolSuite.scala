...
import resample4s.consumer.{PublicExactDesign, PublicGeneralDesign}
...
"""
  ...
  test("canonical design bytes have a pre-hash compatibility fixture") {
        ...
        DesignDescriptor.of(
          ...
          IArray.unsafeFromArray(
            Array[(String, DescriptorValue)](
              ...
              ("title", right(DescriptorValue.text("resample4s λ")))
            )
          )
        )
      )
    ...
    assertEquals(
      observed,
      "0400000014726573616d706c6534732f64657369676e2f7631070400000006646573" +
        "69676e040000000f627974652d666978747572652f76310600000003040000000765" +
        "6e61626c65640301040000000473697a65010000000704000000057469746c650400" +
        "00000d726573616d706c65347320cebb030101000000030100000002060000000301" +
        "0000000001000000010100000000"
    )
  }
