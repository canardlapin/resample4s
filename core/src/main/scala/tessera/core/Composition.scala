...
object Compose:
  ...
  private def draw[F <: Reindexing, G <: Reindexing]
    ...
    new Compose[F, G]:
      type Out = Draw
      private[tessera] def compose(left: F, right: G): Draw =
  ...
  private def injection[F <: Reindexing, G <: Reindexing]
    ...
    new Compose[F, G]:
      type Out = Injection
      private[tessera] def compose(left: F, right: G): Injection =
  ...
  private def selection[F <: Reindexing, G <: Reindexing]
    ...
    new Compose[F, G]:
      type Out = Selection
      private[tessera] def compose(left: F, right: G): Selection =
  ...
  private def permutation[F <: Reindexing, G <: Reindexing]
    ...
    new Compose[F, G]:
      ...
      private[tessera] def compose(left: F, right: G): Permutation =
